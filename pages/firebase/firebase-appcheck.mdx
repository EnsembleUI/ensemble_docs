...
<Callout type="warning">
  App Check integration requires proper Firebase configuration. Ensure your Firebase project is set up before proceeding. Learn how to configure it [here](pages/firebase/configuration.mdx#2-configure-ensemble-app).
</Callout>
...
To enable App Check security in your Ensemble application, add an environment variable named `firebase_app_check` and set its value to `true` to enforce App Check security across your application.
