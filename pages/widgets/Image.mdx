...
<EnsemblePreview
  ...
  screenId="7c7a3ffe-68ef-4e99-b9d1-4b5cee166233"
  height="700px"
/>
...
| :------- | :----- | :---------- |
| source   | string | URL to or asset name of the image or an inline SVG string starting with '<svg'. If the URL is used, it is highly recommended that the dimensions is set (either with width/height or other means) to prevent the UI jerkiness while loading. |
