...
| `safeAreaBottom`  | Returns the height of the screen's safe area at the bottom (e.g., iPhone's home swiper) in logical pixels. This value will be 0 if it is not applicable. For more detailed information on how to use it with example, Click [here](../tips-and-tricks/bottom-save-area.md). |
