...
<Callout type="warning">
  App Check integration requires proper Firebase configuration. Ensure your Firebase project is set up before proceeding. Learn how to configure it [here](firestore-operations.mdx#2-types-of-firestore-operations).
</Callout>
