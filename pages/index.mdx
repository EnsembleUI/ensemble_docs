...
1. Ensemble apps are native to each platform: iOS, Android, web, and desktop.
2. Ensemble apps can be updated instantly because the app definitions can be pushed to clients.
