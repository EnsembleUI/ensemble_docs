...
| enableRange  | boolean  | Turning it true will give you two thumbs                           |
| startValue   | number  | Starting position of thumb (incase of range slider)                  |
| endValue     | number  | Ending position of thumb (incase of range slider)                  |
