...
<EnsemblePreview appId="e24402cb-75e2-404c-866c-29e6c3dd7992" screenId="X4CAuRtGsjBTMnACPhd7" height="700px" />
...
| `orientation`     | Returns the current orientation of the device's screen. Updates automatically when device orientation changes.                                                                                                                                                              |
...
| `safeAreaBottom`  | Returns the height of the screen's safe area at the bottom (e.g., iPhone's home swiper) in logical pixels. This value will be 0 if it is not applicable. For more detailed information on how to use it with example, Click [here](../tips-and-tricks/bottom-safe-area.md). |

Note: The device properties will automatically update when changes occur, such as screen rotation or size changes. Your UI will reflect these changes in real-time.
